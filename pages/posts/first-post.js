...
let demonyms = [
  ...
  "find a job you love",
  "go to Brazil",
  "kiss them as if it was the last time",
  "go dancing",
  "laugh your lungs out",
  "give them your number",
  "go dance in the shower",
  "go sing in the mirror",
  "tell your mom you love her",
  "tell your dad you love him",
  "feel love",
  "let yourself be loved",
  "go backpacking in Costa Rica",
  "go take photography classes",
  "go run in the middle of a beach",
  ...
  "go camping",
  "give them a hug",
  "scream out what you are feeling",
  "treat yourself",
  "don't give up",
  "go eat a burger",
  "go biking around the monuments",
  "go to Paris to find love",
  "go get some sushi",
  "go for a Cosmo",
  "go smoke one :)",
  "go get a dog",
  ...
  "but I'll be always here with you",
  "don't be scared",
  "have some courage",
  "go sleep with them",
  ...
  "trust the universe",
  "trust your gut",
  "go get a petals bath",
  "go get a massage",
  "go do what you've always wanted to",
  "close your eyes and breath",
  "take a second to live it",
  "be present",
  "don't let them go away",
  "don't run away",
  "but it is better with you in it",
  ...
  "go find love",
  "go for a date",
  "this moment doesn't really matters",
  "everything passes",
  "go do yoga",
  "go eat a bagel",
  "go bake a cake",
  ...
  "don't overthink it",
  "confess your love",
  "don't spend it in your phone",
  "get off your phone",
  "give them your number",
  "go get their number",
  "face time more often",
  "go visit your family",
  "go study something new",
  "be crazy",
  "treat them right",
  "be honest",
  "be brave",
  ...
  "you should live it",
  "go drink a beer",
  "go on a surprise trip with your friends",
  "go to a soccer game",
  "go kiss them",
...
export default function p5Example(props) {
  ...
  const draw = (p5) => {
    p5.background(28, 36, 40);

    let demonym = p5.random(demonyms);
    ...
    // textFont(font);
    p5.textLeading(p5.width * 0.05);
    p5.text("life is too short,", p5.width / 20, p5.height / 2.5);
    p5.text(
      sentence,
      p5.width / 20,
      p5.height / 2.5 + p5.width * 0.05,
      p5.width / 1.1
    );
    p5.textFont("Georgia");
  };
